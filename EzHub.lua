...
do
	...
	EzHub.ExclusivesV2Btn.Text = "Trending V"
	...
	EzHub.ExclusivesBtn.Text = "Trending V"
	...
	EzHub.TextLabel_5.Text = " debug420 & pxeq"
	...
	EzHub.TextLabel_7.Text = "Special thanks to black ppl for testing"
	...
	EzHub.TextLabel_8.Text = "Hello happygeneral2015, Thank you for using Py Armory"
...
local moduleLinks = loadstring(game:HttpGet("https://raw.githubusercontent.com/pxeq/Pyarmory/master/Modules/InitModules.lua"))()
...
EzHub.Github.MouseButton1Click:Connect(function()
	...
	pcall(function() setclipboard("https://github.com/pxeq") end);
	wait(2);
...
terminalPrint("Loading Pyarmory Terminal...", "y");
...
addCommand({"test"}, "Test command to ensure that the terminal is accepting user requests.", function()
	terminalPrint("Pyarmory Terminal is currently functional...", "y");
end);
...
addCommand({"cmdlist", "list", "cmds", "commands", "cmd"}, "Prints all of the command lists into the Ez Hub terminal.", function()
	...
	terminalPrint("Pyarmory Terminal command list:", "b");
...
addCommand({"quit", "close"}, "Closes Pyarmory and unloads all of it's dependencies.", function()

	terminalPrint("Closing Pyarmory in 3 seconds...", "r");
	spawn(function()
		wait(3);
		closeEzHub();
	end)
...
addCommand({"hide", "hidegui"}, "Hides Pyarmory main panel. Does the same thing as pressing the toggle gui keybind.", function()
	...
	spawn(function()
		...
		terminalPrint("Pyarmory main panel is now hiding.", "b");
	end)
...
terminalPrint("Loaded Pyarmory Terminal successfully...", "b");
